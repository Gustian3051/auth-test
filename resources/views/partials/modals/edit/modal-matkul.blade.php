<div id="edit{{ $data->id }}" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative w-full max-w-2xl max-h-full p-4">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="p-4">
                <form action="{{ route('mata-kuliah.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="gap-2">
                        <div class="mb-2">
                            <label for="kode_matkul" class="block text-sm font-medium text-gray-700">Kode Matakuliah</label>
                            <input type="text" name="kode_matkul" id="kode_matkul" value="{{ old('kode_matkul', $data->kode_matkul) }}"
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" name="nama_matkul" id="nama_matkul" value="{{ old('nama_matkul', $data->nama_matkul) }}"
                                class="block w-full mt-2 border-gray-300 rounded-lg shadow-sm focus:border-green-500 focus:ring focus:ring-green-500 focus:ring-opacity-50">
                            @error('nama_matkul')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
