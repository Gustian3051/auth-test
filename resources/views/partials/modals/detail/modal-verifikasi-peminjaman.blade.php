                        ...
                        <div class="max-w-screen-xl mx-auto">
                            <div class="w-full bg-white border border-gray-200 rounded-lg shadow p-3">
                                <div class="flex justify-between">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <img src="{{ asset($detail->foto ?? 'image/barang.png') }}" class="w-12"
                                            alt="Gambar">
                                        <div>
                                            <p class="text-sm font-semibold ms-4">{{ $detail->alatBahan->nama }}</p>
                                ...
                                <div class="mt-4">
                                    ...
                                    <input id="jumlah_pinjam" type="number" readonly value="{{ $detail->jumlah }}"
                                ...
                                <div class="mt-4">
                                    <label for="tindakan_SPO_{{ $detail->id }}" class="block py-2 text-sm font-medium">
                                        Tindakan SPO
                                    </label>
                        ...
                        <div class="flex justify-between">
                            <div class="flex items-center gap-2">
                                <img src="{{ asset($detail->foto ?? 'image/barang.png') }}" class="w-12"
                                    alt="Gambar">
                                <div>
                                    <p class="text-sm font-semibold ms-4">{{ $detail->peminjaman->ruangLaboratorium->nama }}
                                    </p>
                                </div>
                            </div>
                        </div>
