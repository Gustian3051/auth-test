<div id="tambah-dokumen-spo" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 border-b rounded-t md:p-5 dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="tambah-dokumen-spo">
            ...
            <form action="{{ route('dokumen-spo.store') }}" class="p-4 md:p-5" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="gap-2">
                    <div class="mb-2">
                        <label for="nama_dokumen" class="block text-sm font-medium text-gray-700">Nama Dokumen
                            SPO</label>
                        <input type="text" name="nama_dokumen" id="nama_dokumen"
                            placeholder="Masukan Nama Dokumen SPO"
                    ...
                    <div class="mb-2">
                        <label for="file_dokumen" class="block text-sm font-medium text-gray-700">File Dokumen
                            SPO</label>
