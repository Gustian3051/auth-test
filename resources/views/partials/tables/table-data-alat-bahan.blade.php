    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400" style="100%"
        ...
        <tbody>
            @foreach ($dataAlatBahan as $data)
                ...
                @include('partials.modals.detail.modal-alat-bahan', ['dataAlatBahan' => $dataAlatBahan, 'dataKategori' => $dataKategori, 'dataSatuan' => $dataSatuan])
                @include('partials.modals.edit.modal-alat-bahan', ['dataAlatBahan' => $dataAlatBahan, 'dataKategori' => $dataKategori, 'dataSatuan' => $dataSatuan])
            @endforeach
        </tbody>
    </table>
</div>
