            ...
            <div class="p-4 bg-white rounded-lg shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <button data-modal-target="tambah-dokumen-spo" data-modal-toggle="tambah-dokumen-spo"
                            class="justify-center px-4 py-2 text-white bg-green-500 rounded hover:bg-green-800">
                            <i class="fa-solid fa-plus"></i>
                        </button>
                        @include('partials.modals.tambah.modal-dokumen-spo')
                    </div>
                    <div class="flex items-center gap-2">
                        <form method="GET" action="{{ route('dokumen-spo.index') }}" class="flex items-center gap-2">
                            <!-- Input pencarian -->
                ...
                <div class="mt-4">
                    <div id="tableDokumenSPO">
                        @include('partials.tables.table-data-dokemen-spo', [
                            'dataDokumenSPO' => $dataDokumenSPO,
                        ])
                    </div>
                    <div class="mt-3">
                        {{ $dataDokumenSPO->links() }}
                    </div>
                </div>
            </div>
        </div>
