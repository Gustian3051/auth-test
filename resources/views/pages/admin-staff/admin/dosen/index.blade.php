            ...
            <div class="p-4 bg-white rounded-lg shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        ...
                        @include('partials.modals.tambah.modal-dosen')
                        ...
                        @include('partials.modals.import.modal-dosen')
                    </div>
                    <div class="flex items-center gap-2">
                        <form method="GET" action="{{ route('dosen.index') }}" class="flex items-center gap-2">
                            <!-- Input pencarian -->
                ...
                <div class="mt-4">
                    <div id="tableDosen">
                        @include('partials.tables.table-data-dosen', [
                            'dataDosen' => $dataDosen,
                        ])
                    </div>
                    <div class="mt-3">
