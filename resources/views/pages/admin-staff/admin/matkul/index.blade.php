            ...
            <div class="p-4 bg-white rounded-lg shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <button data-modal-target="tambah-matkul" data-modal-toggle="tambah-matkul"
                            class="justify-center px-4 py-2 text-white bg-green-500 rounded hover:bg-green-800">
                            <i class="fa-solid fa-plus"></i>
                        </button>
                        @include('partials.modals.tambah.modal-matkul')

                        <button data-modal-target="import-matkul" data-modal-toggle="import-matkul"
                            data-tooltip-target="import" data-tooltip-placement="left"
                            class="justify-center px-4 py-2 text-white bg-green-500 rounded hover:bg-green-800">
                            <i class="fa-solid fa-file-arrow-up"></i>
                        </button>
                        @include('partials.modals.import.modal-matkul')
                    </div>
                    <div class="flex items-center gap-2">
                        <form method="GET" action="{{ route('mata-kuliah.index') }}" class="flex items-center gap-2">
                            <!-- Input pencarian -->
                ...
                <div class="mt-4">
                    <div id="tableMatkul">
                        @include('partials.tables.table-data-matkul', [
