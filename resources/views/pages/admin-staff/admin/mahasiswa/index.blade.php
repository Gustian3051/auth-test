            ...
            <div class="p-4 bg-white rounded-lg shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <button data-modal-target="tambah-mahasiswa" data-modal-toggle="tambah-mahasiswa"
                            class="justify-center px-4 py-2 text-white bg-green-500 rounded hover:bg-green-800">
                            <i class="fa-solid fa-plus"></i>
                        </button>
                        @include('partials.modals.tambah.modal-mahasiswa')

                        <button data-modal-target="import-mahasiswa" data-modal-toggle="import-mahasiswa"
                            data-tooltip-target="import" data-tooltip-placement="left"
                            class="justify-center px-4 py-2 text-white bg-green-500 rounded hover:bg-green-800">
                            <i class="fa-solid fa-file-arrow-up"></i>
                        </button>
                        @include('partials.modals.import.modal-mahasiswa')
                    </div>
                    <div class="flex items-center gap-2">
                        <form method="GET" action="{{ route('mahasiswa.index') }}" class="flex items-center gap-2">
                            <!-- Input pencarian -->
                            <input type="text" name="search" placeholder="Cari nama, NIM, atau kelas..."
                ...
                <div class="mt-4">
                    <div id="tableMahasiswa">
                        @include('partials.tables.table-data-mahasiswa', [
