            ...
            <div class="p-4 bg-white rounded-lg shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <button data-modal-target="tambah-admin-staff" data-modal-toggle="tambah-admin-staff"
                            class="justify-center px-4 py-2 text-white bg-green-500 rounded hover:bg-green-800">
                            <i class="fa-solid fa-plus"></i>
                        </button>
                        @include('partials.modals.tambah.modal-admin-staff')
                ...
                <div class="mt-4">
                    <div id="tableAdminStaff">
                        @include('partials.tables.table-data-admin-staff', [
                            'dataAdminStaff' => $dataAdminStaff,
                        ])
                    </div>
                    <div class="mt-3">
                        {{ $dataAdminStaff->links() }}
                    </div>
                </div>
            </div>
        </div>
