            ...
            <div class="p-4 bg-white rounded-lg shadow-lg">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        <form method="GET" action="{{ route('verifikasi-pengembalian.index') }}" class="flex items-center gap-2">
                            <!-- Input pencarian -->
                ...
                <div class="mt-4">
                    <div id="tableVerifikasiPengembalian">
                        @include('partials.tables.table-verifikasi-pengembalian', [
