            ...
            <div class="p-4 bg-white rounded-lg shadow-lg">
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-2">
                        <button data-modal-target="tambah-alat-bahan" data-modal-toggle="tambah-alat-bahan"
                            class="justify-center px-4 py-2 text-white bg-green-500 rounded hover:bg-green-800">
                            <i class="fa-solid fa-plus"></i>
                        </button>
                        @include('partials.modals.tambah.modal-alat-bahan')

                        <button data-modal-target="import-alat-bahan" data-modal-toggle="import-alat-bahan"
                            class="justify-center px-4 py-2 text-white bg-green-500 rounded hover:bg-green-800">
                            <i class="fa-solid fa-file-arrow-up"></i>
                        </button>
                        @include('partials.modals.import.modal-alat-bahan')
                    </div>
                    <div class="flex items-center gap-2">
